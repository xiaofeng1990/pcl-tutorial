...
int main(int argc, char **argv)
{
    ...
    // {
    //     if (pcl::console::find_argument(argc, argv, "-s") >= 0 || pcl::console::find_argument(argc, argv, "-sf") >=
    //     0)
    //     {
    ...
    pcl::io::loadPCDFile<pcl::PointXYZ>("./data/cloud_dipan.pcd", *cloud);
    ...
    //     final, pcl::visualization::PointCloudColorHandlerCustom<pcl::PointXYZ>(final, 0.0, 255.0, 0.0), "final");
    // visu.addPointCloud<pcl::PointXYZ>(
    //     cloud, pcl::visualization::PointCloudColorHandlerCustom<pcl::PointXYZ>(cloud, 0.0, 0.0, 255.0), "cloud");
    // visu.spin();
