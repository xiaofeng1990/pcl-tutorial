                                                                ...
                                                                pcl::PointCloud<pcl::Normal>::ConstPtr normals)
{
    ...
    viewer->addPointCloud<pcl::PointXYZRGB>(cloud, rgb, "sample cloud");
    viewer->setPointCloudRenderingProperties(pcl::visualization::PCL_VISUALIZER_POINT_SIZE, 3, "sample cloud");
    viewer->addPointCloudNormals<pcl::PointXYZRGB, pcl::Normal>(cloud, normals, 5, 0.05, "normals");
    viewer->addCoordinateSystem(1.0);
    viewer->initCameraParameters();
    return (viewer);
}
                                                                  ...
                                                                  pcl::PointCloud<pcl::Normal>::ConstPtr normals2)
{
    ...
    viewer->setPointCloudRenderingProperties(pcl::visualization::PCL_VISUALIZER_OPACITY, 3, "sample cloud2");
    viewer->addCoordinateSystem(1.0);
